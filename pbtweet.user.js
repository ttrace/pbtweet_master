...
function pb_css_set()
{
	...
	document.styleSheets[0].insertRule('div.conv_chain .actions .pb-fav-action {display:block; cursor:pointer; padding:4px 6px;background-position: 50% 50%; background-repeat:no-repeat;}',oLength+19);
