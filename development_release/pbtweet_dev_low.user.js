...
function pb_css_set()
{
	...
	// for snip url
	document.styleSheets[0].insertRule('a.pb-snip-url {display:inline-block;margin:-3px -4px; padding: 1px 4px; border:1px solid transparent; text-decoration:none; -webkit-border-top-left-radius: 5px 5px;-webkit-border-top-right-radius: 5px 5px;}',oLength+44);
	...
	document.styleSheets[0].insertRule('a.pb-snip-url span {display:block; opacity: 0; position:absolute ;min-width:250px;max-width:400px;  min-height: 16px;margin:0px 0px 0px -5px;padding: 5px 5px; background-color: white; text-decoration:underline; -webkit-box-shadow: 0px 4px 4px rgba(0%, 0%, 0%, 0.4);-webkit-transform:scale(0, 0);-webkit-transform-origin:0% 0%;}',oLength+46);
	...
	document.styleSheets[0].insertRule('ol.statuses div.conv_chain .pb-extra {width:190px; margin-left:200px;}',oLength+53);
	document.styleSheets[0].insertRule('ol.statuses span.pb-extra .pb-trans {margin-right: 4px; height:12px;-webkit-border-radius:6px 6px; -webkit-transition:background 0.2s ease-in, color 0.2s ease-in;}',oLength+54);
	document.styleSheets[0].insertRule('ol.statuses span.pb-extra .pb-trans:hover {color: #444; border:1px solid white; background-color:rgb(99%,92%,39%);}',oLength+55);
